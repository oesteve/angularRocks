...
angular.module('angularRocksApp')
        .factory('bands', function () {
            ...
            var bands = [{
                    ...
                    summary: 'Banda británica de rock originaria de Londres fundada en abril de 1962',
                    ...
                    summary: 'Banda de rock inglesa activa durante la década de 1960',
                    ...
                    summary: 'Una banda británica de rock formada en 1970 en Londres por el cantante Freddie Mercury',
